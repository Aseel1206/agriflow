...
if not data_file_path.exists():
    print(f"Error: The file {DATA_FILE} does not exist. Please upload it or check the path.")
...
# ============================================================
# 25.1 AI PRICE RECOMMENDATION
# ============================================================

print("\n" + "=" * 60)
print("AI PRICE RECOMMENDATION")
print("=" * 60)


# ------------------------------------------------------------
# 1. EXPECTED PRICE CHANGE
# ------------------------------------------------------------

results["expected_price_change_pct"] = (
    (
        results["predicted_price"]
        -
        results["avg_price"]
...
# ------------------------------------------------------------
#
# 70% weight -> predicted next-day price
# 30% weight -> current market price
#
# This gives a practical target rather than blindly
# using the predicted value.
# ------------------------------------------------------------

results["recommended_price"] = (
    0.70 * results["predicted_price"]
    +
    0.30 * results["avg_price"]
)
...
results["recommended_price_low"] = (
    results["recommended_price"] * 0.97
)

results["recommended_price_high"] = (
    results["recommended_price"] * 1.03
)
...
def get_recommendation(row):
    ...
    if expected_change >= 5:
        ...
        return "Hold / Target higher price"
        ...
        return "Sell at current/target price"
...
results["recommendation_confidence"] = (
    results.apply(
        get_confidence,
        axis=1
    )
...
# ============================================================
# 25.2. SAVE AI PRICE RECOMMENDATIONS
# ============================================================

RECOMMENDATIONS_FILE = (
    "ai_price_recommendations.csv"
)
...
print(
    f"\nAI price recommendations saved to: "
    f"{RECOMMENDATIONS_FILE}"
)

# ============================================================
# 25.3 PERFORMANCE BY CROP
# ============================================================
...
print("1. price_model.txt")
print("2. price_predictions.csv")
print("3. price_feature_importance.png")
print("4. price_metrics_by_crop.csv")
print("5. price_metrics_by_state.csv")
print("6. ai_price_recommendations.csv")